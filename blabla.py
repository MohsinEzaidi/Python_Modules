...
class BaseBlaBla(BaseModel):
    ...
    def checker(self) -> None:
        if self.x == self.y:
            raise ValueError('x cannot be same as y')
        return self


try:
    test = BaseBlaBla(x=9, y=9, lala='wow')
    print(test)
...
#         print(f'Status: {"" if space_station.is_operational else "Not "}Operational')
